...
Deno.test({
  name:
    "escape: webr::eval_js cannot read arbitrary host files (fs.readFileSync)",
...
Deno.test({
  name:
    "escape: webr::eval_js cannot write to arbitrary host paths (fs.writeFileSync)",
  sanitizeResources: false,
  sanitizeOps: false,
  timeout: 120_000,
  async fn() {
...
Deno.test({
  name:
    "escape: webr::eval_js cannot exec host commands (child_process.execSync)",
  sanitizeResources: false,
  sanitizeOps: false,
  timeout: 120_000,
  async fn() {
